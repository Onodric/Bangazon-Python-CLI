...
class Payment:
    ...
    def set_payment_info(self):
        """
        A method that will set the payment type and account number information for an instance of payment
        Author: Dani Adkins
        """
        self.__payment_type
    ...
    def get_full_payment_info_current_account_current_user(self):
        """
        A method that will return a string with full payment info for the current accound and current
        user for an instance of payment
        Author: Dani Adkins
        """
